 ...
 *
 * @param db [BetterSqlite3.Database] The database connection (Specifically a
 * BetterSqlite3.Database which you can get from ~/utils/db.server)
 */
export function deleteAllData(db: BetterSqlite3.Database) {
